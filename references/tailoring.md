...
renderer fits whatever you write onto one page and tells you how full it is — write for
a full page, then adjust from the measured `fill`. An underfilled page reads as a thin
...
Write exactly this shape — the renderer reads it directly. No markdown fences, no
